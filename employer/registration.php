  ...
  <style>
    * {
    ...
    .input-field {
      ...
      padding: 0 0.4rem;
      position: relative;
      box-shadow: 0 8px 25px rgba(80, 143, 233, 0.12);
    ...
    .input-field:focus-within {
      ...
      box-shadow: 0 10px 30px rgba(80, 143, 233, 0.25);
    ...
    .btn {
      ...
      cursor: pointer;
      transition: 0.3s;
      box-shadow: 0 12px 25px rgba(80, 143, 233, 0.35);
    }

    .btn:hover {
      transform: translateY(-3px);
      box-shadow: 0 16px 35px rgba(80, 143, 233, 0.45);
    }

    .btn.solid {
      background: linear-gradient(135deg, rgb(80, 143, 233), #3f74d9);
    }
    ...
    .container:before {
      ...
      border-radius: 50%;
      z-index: 6;
      box-shadow: 0 30px 90px rgba(80, 143, 233, 0.35);
    }

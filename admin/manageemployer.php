...
<head>
  ...
  <title>JRS Admin | Verify Employer</title>
...
<main class="main-content">
  ...
  <div class="page-header">
    <h1 class="fw-bold mb-2">Verify Employer Account</h1>
    <p class="mb-0">Review pending employer accounts and open details for verification.</p>
  </div>
        ...
        <tbody>
          ...
          ?>
            <tr>
              ...
              <td><?php echo $CP; ?></td>
              <td>
                <a class="detail-btn" href="DetailEmp.php?EmpId=<?php echo $Id; ?>">
                  View Detail
                </a>
              </td>
            </tr>

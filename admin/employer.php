...
<head>
  ...
  <title>JRS Admin | Employers</title>
...
<main class="main-content">
  ...
  <div class="page-header">
    <h1 class="fw-bold mb-2">Employers</h1>
    <p class="mb-0">View confirmed employers and manage employer account status.</p>
  </div>
        ...
        <tbody>
          ...
          ?>
            <tr>
              ...
              <td>
                <a class="deactivate-btn" href="deactivate.php?EmpId=<?php echo $row['Employer_Id']; ?>">
                  Deactivate
                </a>
              </td>
            </tr>

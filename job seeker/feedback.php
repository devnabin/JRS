  ...
  <div class="row">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
      ...
      <div class="page-header">
        <h1>Your Feedback</h1>
        <p>Share your feedback to help improve the job recommendation system.</p>
      </div>

      <div class="feedback-card">
        <h3 class="section-title"><span></span>Give Your Feedback</h3>

        <div class="helper-text">
          Write your experience, suggestion, or issue in the box below.
        </div>
